    		...
    		<div id="page-inner">
        		...
        		<div id="pageNavication" class="text-center">
        			<ul class="list-inline">
        				<li>
        					<a href="/NewsRelease/servlet/NewsManageServlet?curPage=1">
        				...
        				<li>
        					<a href="/NewsRelease/servlet/NewsManageServlet?curPage=${curPage-1}">
        						<button class="btn btn-default">	
        						前一页
        						</button>
        					</a>
        				...
        				<c:forEach var="i" begin="${beginPage}" end="${endPage}">
        					<li>
        					  ...
        					  <c:if test="${i!=curPage}">
        						<a href="/NewsRelease/servlet/NewsManageServlet?curPage=${i}">
        							<button class="btn btn-default">	
        								<c:out value="${i}"></c:out> 
        							</button>
        						</a>
        				...
        				<li>
        					<a href="/NewsRelease/servlet/NewsManageServlet?curPage=${allNewsPage}">
        						<button class="btn btn-default">	
        						尾页
        						</button>
        					</a>
